...
An empty `.zodiac-indicators` container can be added within the carousel to
generate one indicator button for each item:

``` html
<div class="zodiac-indicators"></div>
```

Indicator generation can be disabled with the `enableIndicators` option.
...
| enableIndicators  | boolean                                                      | `true`                               | Enables indicator controls when a `.zodiac-indicators` container is present. This setting is not available in the media query options.                                                                                                                                                                                                                              |
...
| infiniteScrolling | boolean                                                      | `true`                               | Allows the slider to transition endlessly.                                                                                                                                                                                                                                                                                                                           |
...
| pauseOnLoad       | boolean                                                      | `false`                              | Whether or not autoplay should be paused when the slider loads. This setting is not available in the media query options.                                                                                                                                                                                                                                          |
